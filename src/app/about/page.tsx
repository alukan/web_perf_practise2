                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-12">
                        <div className="team-thumb">
                            <Image src="/assets/images/team/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg" height="200" width="200"className="img-fluid team-image" alt=""/>
                    ...
                    <div className="col-lg-4 col-12 my-lg-0 my-4">
                        <div className="team-thumb">
                            <Image src="/assets/images/team/nicolas-horn-MTZTGvDsHFY-unsplash.jpg" height="200" width="200"className="img-fluid team-image" alt=""/>
                    ...
                    <div className="col-lg-4 col-12">
                        <div className="team-thumb">
                            <Image src="/assets/images/team/rc-cf-FMh5o5m5N9E-unsplash.jpg" height="200" width="200"className="img-fluid team-image" alt=""/>
        ...
        <section className="newsletter section-padding bg-white">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                        <Image src="/assets/images/charles-deluvio-FdDkfYFHqe4-unsplash.jpg" height="200" width="200"className="img-fluid newsletter-image" alt=""/>
                    </div>
