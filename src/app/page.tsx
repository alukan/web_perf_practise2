                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <div className="carousel-image-wrap">
                                            <Image src="/assets/images/slide/jay-wennington-N_Y88TWmGwA-unsplash.jpg" width="100" height="100" className="Image-fluid carousel-image" alt="" />
                                        </div>
                                    ...
                                    <div className="carousel-item">
                                        <div className="carousel-image-wrap">
                                            <Image src="/assets/images/slide/jason-leung-O67LZfeyYBk-unsplash.jpg" width="100" height="100" className="Image-fluid carousel-image" alt="" />
                                        </div>
                                    ...
                                    <div className="carousel-item">
                                        <div className="carousel-image-wrap">
                                            <Image src="/assets/images/slide/ivan-torres-MQUqbmszGGM-unsplash.jpg" width="100" height="100" className="Image-fluid carousel-image" alt="" />
                                        </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/breakfast/brett-jordan-8xt8-HIFqc8-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/lunch/farhad-ibrahimzade-MGKqxm6u2bc-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/dinner/keriliwi-c3mFafsFz2w-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/breakfast/louis-hansel-dphM2U1xq0U-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <div className="menu-image-wrap">
                                    <Image src="/assets/images/lunch/farhad-ibrahimzade-D5c9ZciQy_I-unsplash.jpg" width="100" height="100" className="Image-fluid menu-image" alt="" />
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                <Link href="news-detail.html">
                                    <Image src="/assets/images/news/pablo-merchan-montes-Orz90t6o0e4-unsplash.jpg" width="100" height="100" className="Image-fluid news-image" alt="" />
                                </Link>
                        ...
                        <div className="col-lg-6 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                <Link href="news-detail.html">
                                    <Image src="/assets/images/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg" width="100" height="100" className="Image-fluid news-image" alt="" />
                                </Link>
                        ...
                        <div className="col-lg-4 col-md-4 col-12">
                            <div className="news-thumb mb-lg-0 mb-lg-4 mb-0">
                                <Link href="news-detail.html">
                                    <Image src="/assets/images/news/gilles-lambert-S_LhjpfIdm4-unsplash.jpg" width="100" height="100" className="Image-fluid news-image" alt="" />
                                </Link>
                        ...
                        <div className="col-lg-4 col-md-4 col-12">
                            <div className="news-thumb mb-lg-0 mb-lg-4 mb-2">
                                <Link href="news-detail.html">
                                    <Image src="/assets/images/news/caroline-attwood-bpPTlXWTOvg-unsplash.jpg" width="100" height="100" className="Image-fluid news-image" alt="" />
                                </Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="news-thumb mb-4">
                                <Link href="news-detail.html">
                                    <Image src="/assets/images/news/louis-hansel-GiIiRV0FjwU-unsplash.jpg" width="100" height="100" className="Image-fluid news-image" alt="" />
                                </Link>
