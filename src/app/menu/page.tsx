                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/breakfast/brett-jordan-8xt8-HIFqc8-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/breakfast/lucas-swennen-1W_MyJSRLuQ-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/breakfast/louis-hansel-dphM2U1xq0U-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/lunch/louis-hansel-cH5IPjaAYyo-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                        ...
                        <div className="col-lg-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/lunch/louis-hansel-rheOvfxOlOA-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
            ...
            <section className="menu section-padding">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/dinner/keriliwi-c3mFafsFz2w-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="menu-thumb">
                                <Image src="/assets/images/dinner/farhad-ibrahimzade-isHUj3N0194-unsplash.jpg" width="100" height="100" className="img-fluid menu-image" alt=""/>
